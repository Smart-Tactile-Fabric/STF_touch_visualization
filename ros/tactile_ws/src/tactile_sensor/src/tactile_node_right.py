...
if __name__ == '__main__':
    ...
    right_robot_left_finger_Thread = threading.Thread(target=tactile_publisher, args=('right_robot_left_finger',0.5,))
    right_robot_left_finger_Thread.daemon = True
    right_robot_left_finger_Thread.start()
    right_robot_right_finger_Thread = threading.Thread(target=tactile_publisher, args=('right_robot_right_finger',0.5,))
